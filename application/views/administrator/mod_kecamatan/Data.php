    				...
    				<div class="box-body">
    					<table id="example1" class="table table-bordered table-striped">
    						<thead>
    							<tr>
    								<td colspan="7">
    									<a href="<?=base_url()?>administrator/tambah_kecamatan" class="btn btn-block btn-primary">Tambah Data</a>
    								</td>
    							</tr>
    							<tr>
    								<th>NO</th>
    						...
    						<tbody>
    							...
    							foreach ($kecamatan as $f) { ?>
    								<tr>
    									...
    									<td>
    										<div class="btn-group">
    											<a href="<?=base_url()?>administrator/edit_kecamatan/<?=$f['id_kecamatan']?>" class="btn btn-success">Edit</a>
    											
    											<button type="button" class="btn btn-default" disabled=""><i class="fa fa-align-center"></i></button>

    											<a href="<?=base_url()?>administrator/hapus_kecamatan/<?=$f['id_kecamatan']?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini ?')">Hapus</a>
    										</div>
    									</td>
    								</tr>
    							<?php $no++; } ?>
