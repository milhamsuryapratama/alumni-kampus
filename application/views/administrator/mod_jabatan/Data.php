    				...
    				<div class="box-body">
    					<table id="example1" class="table table-bordered table-striped">
    						<thead>
    							<tr>
    								<td colspan="7">
    									<a href="<?=base_url()?>administrator/tambah_jabatan" class="btn btn-block btn-primary">Tambah Data</a>
    								</td>
    							</tr>
    							<tr>
    								<th>NO</th>
    						...
    						<tbody>
    							...
    							foreach ($jabatan as $l) { ?>
    								<tr>
    									...
    									<td>
    										<div class="btn-group">
    											<a href="<?=base_url()?>administrator/edit_jabatan/<?=$l['id_jabatan']?>" class="btn btn-success">Edit</a>
