    	...
    	<div class="row">
    		<div class="col-md-12">
    			...
    			<div class="box box-primary">
    				...
    				<!-- /.box-header -->
    				<!-- form start -->
    				<form action="<?=base_url()?>administrator/tambah_prodi" method="post">
    					<div class="box-body">
    						<div class="form-group">
    							<label for="nama_prodi">Nama Prodi</label>
    							<input type="text" name="nama_prodi" class="form-control" id="nama_prodi" placeholder="Enter Nama Prodi">
    						</div>
                            <div class="form-group">
