    				...
    				<form action="<?=base_url()?>administrator/tambah_anggota_fks" method="post">
    					<div class="box-body">
    						<div class="form-group">
    							...
    							<input type="text" name="nis" class="form-control" id="nis" placeholder="Enter Nomor Induk Siswa">
    						</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="desa" class="form-control" id="desa" placeholder="Enter Nama Desa">
                            </div>
                            <div class="form-group">
                                <label for="kecamatan">Kecamatan</label>
                                <input type="text" name="kecamatan" class="form-control" id="kecamatan" placeholder="Enter Kecamatan">
                            </div>
                            <div class="form-group">
                                <label for="gang_wilayah">Gang / Wilayah</label>
                                <input type="text" name="gang_wilayah" class="form-control" id="gang_wilayah" placeholder="Enter Gang / Wialayah">
                            </div>
                            <div class="form-group">
