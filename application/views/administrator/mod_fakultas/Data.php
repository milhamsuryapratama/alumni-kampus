    				...
    				<div class="box-body">
    					<table id="example1" class="table table-bordered table-striped">
    						<thead>
    							<tr>
    								<td colspan="7">
    									<a href="<?=base_url()?>administrator/tambah_fakultas" class="btn btn-block btn-primary">Tambah Data</a>
    								</td>
    							</tr>
    							<tr>
    								<th>NO</th>
    								...
    								<tr>
    									...
    									<td>
    										<div class="btn-group">
    											...
    											<a href="<?=base_url()?>administrator/hapus_fakultas/<?=$f['id']?>" class="btn btn-danger">Hapus</a>
    										</div>
    									</td>
    								</tr>
    							<?php $no++; } ?>
