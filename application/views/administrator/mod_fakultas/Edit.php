    	...
    	<div class="row">
    		<div class="col-md-12">
    			...
    			<div class="box box-primary">
    				...
    				<!-- /.box-header -->
    				<!-- form start -->
    				<form action="<?=base_url()?>administrator/edit_fakultas" method="post">
    					<div class="box-body">
                            <input type="hidden" name="id" value="<?=$f['id']?>">
    						<div class="form-group">
    							<label for="nama_fakultas">Nama Fakultas</label>
    							<input type="text" name="nama_fakultas" class="form-control" id="nama_fakultas" value="<?=$f['nama_fakultas']?>" placeholder="Enter Nama Fakultas">
    						</div>
    					</div>
    					<!-- /.box-body -->
